...
<body>
  <div class="container">
    ...
    <h2>Индексированные массивы</h2>
    <div id="indexedArrays">
      <p>Фрукты: <span id="fruitsDisplay"></span></p>
      <input type="text" id="newFruit" placeholder="Новый фрукт">
      <button id="addFruitButton">Добавить фрукт</button>
    </div>

    <h2>Ассоциативные массивы (Объекты)</h2>
    <div id="associativeArrays">
      <p>Имя: <span id="userName"></span></p>
      <p>Возраст: <span id="userAge"></span></p>
      <button id="increaseAgeButton">Увеличить возраст</button>
    </div>

    <h2>Многомерные массивы</h2>
    <div id="multidimensionalArrays">
...
li {
  margin-bottom: 5px;
    ...
    "/index.js": `// Индексированные массивы
...
const userAgeDisplay = document.getElementById("userAge");
const increaseAgeButton = document.getElementById("increaseAgeButton");

function updateUserInfo() {
  userNameDisplay.textContent = user.name;
  userAgeDisplay.textContent = user.age;
}
...
function updateUserList() {
  ...
  users.forEach((user) => {
    ...
    listItem.textContent = \`\${'}user.name'} (\${'}user.age'}) - \${'}user.city'}\`;
