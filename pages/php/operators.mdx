...
<head>
  ...
  <style>
    ...
    input { margin: 10px; padding: 5px; background-color: #3e4451; color: white; border: none; }
    button { padding: 5px 10px; background-color: #61afef; color: white; border: none; cursor: pointer; }
...
<body>
  ...
  <script>
    function calculate() {
      ...
      let output = \`Sum: \${sum}<br>Difference: \${difference}<br>Product: \${product}<br>Quotient: \${quotient}\`;
