...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Синтаксис и переменные в JavaScript</title>
  <link rel="stylesheet" href="/styles.css">
</head>
<body>
  <div class="container">
    <h1>Синтаксис и переменные в JavaScript</h1>
...
`,
    "/index.js": `// Переменные в JavaScript
let userName = "Гость"; // Объявление переменной с помощью let (можно переопределять)
const greeting = "Привет, "; // Объявление константы с помощью const (нельзя переопределять)
...
// Получение элемента DOM для вывода
...
greetButton.addEventListener("click", () => {
  ...
  userName = name; // Обновляем значение переменной userName
...
// Объекты (аналог ассоциативных массивов в PHP)
const user = {
  firstName: "Иван",
  lastName: "Иванов",
  age: 30,
...
const person = new Person("Елена", 25);
