...
<body>
  <div class="container">
    ...
    <h2>Строки</h2>
    <input type="text" id="stringInput" placeholder="Введите строку">
    <button id="stringButton">Обработать строку</button>
    <p id="stringOutput"></p>

    <h2>Числа</h2>
    <input type="number" id="numberInput" placeholder="Введите число">
    <button id="numberButton">Обработать число</button>
    <p id="numberOutput"></p>

    <h2>Массивы</h2>
    <button id="arrayButton">Создать и показать массив</button>
    <p id="arrayOutput"></p>

    <h2>Объекты</h2>
    <button id="objectButton">Создать и показать объект</button>
    <p id="objectOutput"></p>

    <h2>Boolean</h2>
    <button id="booleanButton">Проверить Boolean</button>
    <p id="booleanOutput"></p>
  </div>
...
p {
  margin-bottom: 10px;
  word-wrap: break-word; /* Предотвращает переполнение длинных строк */
}
`,
    "/index.js": `// Строки
...
stringButton.addEventListener('click', () => {
  ...
  stringOutput.textContent = \`Длина: \${'}length\${'}, В верхнем регистре: \${'}upperCase\${'}\`;
});
...
numberButton.addEventListener('click', () => {
  ...
  if (isNaN(num)) {
    numberOutput.textContent = 'Введите корректное число';
    return;
  }
  const squared = num * num;
  numberOutput.textContent = \`Квадрат числа: \${'}squared\${'}\`;
});
...
arrayButton.addEventListener('click', () => {
  ...
  arrayOutput.textContent = \`Массив: \${'}arr.join(', ')\${'}\`;
});
...
objectButton.addEventListener('click', () => {
  ...
  objectOutput.textContent = \`Имя: \${'}obj.name\${'}, Возраст: \${'}obj.age\${'}\`;
});

// Boolean
const booleanButton = document.getElementById('booleanButton');
const booleanOutput = document.getElementById('booleanOutput');

booleanButton.addEventListener('click', () => {
  const value = stringInput.value;
  const isEmpty = !value; // Проверяем, пустая ли строка
  booleanOutput.textContent = \`Строка пустая: \${'}isEmpty\${'}\`;
});
`
  }}
  options={{
