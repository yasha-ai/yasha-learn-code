...
<head>
    ...
    <title>Prepared Statements в JavaScript</title>
    <link rel="stylesheet" href="/styles.css">
</head>
<body>
    <div class="container">
        <h1>Prepared Statements в JavaScript</h1>
        <p>Этот пример демонстрирует концепцию Prepared Statements, используя JavaScript для имитации работы с данными.</p>
        ...
        <button id="submitButton">Добавить пользователя</button>
...
li:last-child {
    ...
    "/index.js": `// Имитация Prepared Statement с использованием JavaScript

// Функция для "экранирования" данных (предотвращение XSS)
