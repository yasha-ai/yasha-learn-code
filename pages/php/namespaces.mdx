...
<html>
<head>
  <title>PHP Namespaces Demo</title>
  <style>
...
<body>
  <div>
    <h1>PHP Namespaces Demo</h1>
    <button id="runBtn">Run PHP Code</button>
    <div id="output"></div>
...
?>\`;
        ...
        document.getElementById('output').textContent = "Running PHP...";
        fetch('/api/run-php', { // Replace with your actual API endpoint
          method: 'POST',
