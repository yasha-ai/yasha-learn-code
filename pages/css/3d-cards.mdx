![CSS 3D Cards](/lessons/css-3d-cards.png)
...
@keyframes rotateCube {
  ...
  to { transform: rotateX(-20deg) rotateY(340deg); }
}
...
.front  { background: #2ecc71; transform: translateZ(100px); }
...
.left   { background: #3498db; transform: rotateY(-90deg) translateZ(100px); }
