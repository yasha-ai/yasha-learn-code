...
![Иллюстрация к уроку](/lessons/css-css-nesting.png)
...
<head>
  ...
  <title>CSS Nesting Пример</title>
  <link rel="stylesheet" href="/styles.css">
</head>
<body>
  <div class="container">
    <h1>CSS Nesting Пример</h1>

    <div class="card">
      <h2>Карточка товара</h2>
      <img src="https://via.placeholder.com/150" alt="Изображение товара">
      <p>Описание товара. Здесь может быть краткое описание продукта.</p>
...
.settings-panel {
  ...
  input[type="color"] {
    ...
    "/index.js": `// Получаем элементы управления цветом
...
// Добавляем слушатели событий для изменения цвета
