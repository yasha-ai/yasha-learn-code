...
<body>
  <header class="fixed-header">
    <h1>CSS Позиционирование</h1>
  </header>

  <div class="container">
    <section>
      <h2>position: static</h2>
      <div class="static-element">Это static элемент.</div>
    </section>

    <section>
      <h2>position: relative</h2>
      <div class="relative-box">
        Это relative элемент.
      </div>
    </section>
    ...
    <section>
      ...
      <div class="parent-relative">
        Родительский элемент (relative)
        <div class="child-absolute">Абсолютно позиционированный ребенок</div>
      </div>
    </section>

    <section>
      <h2>position: fixed</h2>
      <p>Прокрутите страницу, чтобы увидеть fixed элемент в действии.</p>
    </section>
    ...
    <section>
      ...
      <div class="sticky-container">
        ...
        <div class="sticky-content">
          Содержимое sticky элемента. Прокрутите страницу, чтобы увидеть, как заголовок прилипает к верху.
        </div>
      </div>
    </section>

    <section>
        <h2>Интерактивное управление relative элементом</h2>
        <label for="topOffset">Смещение сверху:</label>
        <input type="number" id="topOffset" value="20">

        <label for="leftOffset">Смещение слева:</label>
        <input type="number" id="leftOffset" value="30">

        <button id="updateButton">Обновить позицию</button>
    </section>
  </div>
...
.container {
  margin-top: 80px; /* Чтобы контент не перекрывался fixed header */
}
...
`,
  ...
  updateButton.addEventListener('click', () => {
    const topOffset = topOffsetInput.value;
    const leftOffset = leftOffsetInput.value;

    relativeBox.style.top = \`\${topOffset}px\`;
    relativeBox.style.left = \`\${leftOffset}px\`;
  });
});
`,
  }}
