...
```mermaid
flowchart LR
    HTML[HTML: Скелет<br/>46 уроков] --> CSS[CSS: Стиль<br/>67 уроков]
    CSS --> JS[JavaScript: Мозги<br/>85 уроков]
    JS --> TS[TypeScript: Броня<br/>64 урока]
    TS --> React[React: Движок<br/>63 урока]
    React --> WP[WordPress: WP Pro<br/>15 уроков]
    
    Git[Git: Машина времени<br/>13 уроков]
...
**Всего: 362 урока** | **7 курсов** | **Все темы с диаграммами**
...
### 📄 [HTML: Скелет](/html)
**46 уроков** — от базовых тегов до Web Components и Accessibility.
...
### 🎨 [CSS: Стиль](/css)
**67 уроков** — самый полный курс! От селекторов до современных фич.
...
**85 уроков** — глубокое погружение в язык.
...
**64 урока** — от базовых типов до продвинутых паттернов.
...
**63 урока** — современный React с хуками и оптимизацией.
...
**13 уроков** — управление версиями как профессионал.
