...
<body>
  <h3>Основы Canvas</h3>
  <p>Кликните по холсту, чтобы нарисовать круг!</p>
  ...
  <script>
    ...
    // Рисуем прямоугольник (пример из урока)
    ctx.fillStyle = "#FF0000";
    ctx.fillRect(20, 20, 120, 60);

    // Добавляем интерактивность: рисование круга по клику
    canvas.addEventListener("click", (e) => {
      ...
      ctx.beginPath();
      ctx.arc(x, y, 15, 0, 2 * Math.PI); // Рисуем круг
