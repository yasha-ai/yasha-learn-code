...
<head>
  ...
  <title>IFrame & Embed Demo</title>
  <style>
    body { background-color: #282c34; color: white; font-family: sans-serif; }
    iframe, embed { margin-bottom: 20px; }
  </style>
</head>
<body>

  <h1>IFrame Example</h1>
  <iframe src="https://example.com" width="400" height="200" title="Example Website"></iframe>

  <h1>Embed Example</h1>
  <embed src="https://www.w3schools.com/tags/movie.mp4" type="video/mp4" width="320" height="240">

  <p>Note: Some browsers may require a plugin to play the video.</p>
