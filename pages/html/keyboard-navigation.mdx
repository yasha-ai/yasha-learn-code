...
<body>
  ...
  <nav>
    <a href="#" tabindex="0">Главная</a>
    <a href="#" tabindex="0">О нас</a>
    <a href="#" tabindex="0">Услуги</a>
    <a href="#" tabindex="0">Контакты</a>
  </nav>

  <div class="container">
    <button id="myButton" tabindex="0">Кнопка 1</button>
    <input type="text" id="myInput" placeholder="Введите текст" tabindex="0">
    <div tabindex="0" id="focusableDiv">Этот div доступен для табуляции</div>
    <p tabindex="-1">Этот параграф не доступен для табуляции, но может быть сфокусирован JS</p>
    <button id="focusButton">Сфокусировать параграф</button>
  </div>
...
button:focus, input:focus, div:focus {
  outline: 2px solid #007bff; /* Синяя обводка при фокусе */
}
...
nav a:focus {
  outline: 2px solid #007bff;
    ...
    "/index.js": `// Получаем ссылку на кнопку и параграф
const focusButton = document.getElementById('focusButton');
const paragraph = document.querySelector('p');

// Добавляем обработчик события на кнопку
focusButton.addEventListener('click', () => {
  // Фокусируем параграф с помощью JavaScript
  paragraph.focus();
});

// Добавляем обработчик события focus на параграф
paragraph.addEventListener('focus', () => {
  alert('Параграф получил фокус!');
});
