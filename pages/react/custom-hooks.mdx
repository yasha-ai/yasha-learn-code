...
// Custom Hook для получения данных
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'sans-serif', backgroundColor: '#282c34', color: 'white', minHeight: '400px' }}>
      ...
      <div>
        <h3>Counter</h3>
        <p>Count: {count}</p>
        <button onClick={increment} style={{ margin: '5px', padding: '5px 10px', backgroundColor: '#61dafb', border: 'none', borderRadius: '5px', cursor: 'pointer' }}>Increment</button>
        <button onClick={decrement} style={{ margin: '5px', padding: '5px 10px', backgroundColor: '#61dafb', border: 'none', borderRadius: '5px', cursor: 'pointer' }}>Decrement</button>
        <button onClick={reset} style={{ margin: '5px', padding: '5px 10px', backgroundColor: '#61dafb', border: 'none', borderRadius: '5px', cursor: 'pointer' }}>Reset</button>
      </div>
      ...
      <div>
        ...
        <input
          ...
          style={{ margin: '5px', padding: '5px', borderRadius: '5px', border: '1px solid #ccc', color: 'black' }}
        />
