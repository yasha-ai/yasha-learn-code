...
1. Найдите длинные задачи в вашем приложении через Performance → Long Tasks
2. Добавьте `debounce` к поисковому input (если ещё нет)
3. Переместите тяжёлые вычисления в Web Worker
4. Профилируйте компонент в React DevTools → Profiler

## Ссылки

- [MDN: Web Workers](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API)
- [web.dev: Long tasks](https://web.dev/articles/long-tasks-devtools)
- [JavaScript Optimization Tips](https://v8.dev/blog)
