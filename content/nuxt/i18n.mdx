...
`@nuxtjs/i18n` предоставляет:

- **Автоматическую маршрутизацию** — локализованные URL из коробки
- **Ленивую загрузку** — переводы загружаются по требованию
- **Плюрализацию** — правильные окончания для любого языка
- **SEO** — автоматические hreflang и lang атрибуты
- **TypeScript** — полная типизация переводов
- **Форматирование** — даты, числа, валюты через Intl
