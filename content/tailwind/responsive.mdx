...
1. Создай карточки: 1 колонка на мобильных, 2 на планшете, 4 на десктопе
2. Сделай навигацию: hamburger-иконка на мобильных, полное меню на `md:`
3. Реализуй two-column layout: `flex-col` на мобильных, `flex-row` на `lg:`

### Ключевые моменты

- Mobile-first: стили без префикса = мобильный, `md:` и выше = переопределение
- Основные брейкпоинты: `sm:640px`, `md:768px`, `lg:1024px`, `xl:1280px`
- `hidden md:block` — скрыто на мобильных, видно на планшете+
- `block md:hidden` — видно на мобильных, скрыто на планшете+

### Полезные ссылки

- [Tailwind Responsive Design](https://tailwindcss.com/docs/responsive-design)
- [Responsively App](https://responsively.app) — тестирование responsive layout
