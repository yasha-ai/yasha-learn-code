...
1. Измени цвет фона страницы с `from-slate-900` на `from-purple-900`
2. Добавь третью карточку — придумай свой дизайн используя только Tailwind классы
3. Найди на сайте [tailwindcss.com](https://tailwindcss.com) 3 сайта которые используют Tailwind и посмотри их HTML

### Ключевые моменты

- Tailwind — **utility-first** фреймворк: стили через готовые классы-утилиты
- CSS генерируется только для использованных классов — минимальный размер бандла
- Отлично интегрируется с компонентными фреймворками (React, Vue, Svelte)
- В 2024–2025 — де-факто стандарт для современных веб-приложений
