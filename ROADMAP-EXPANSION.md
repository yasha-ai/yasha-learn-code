...
- [ ] Псевдоклассы :nth-child, :nth-of-type, :not()
- [ ] Псевдоклассы :is(), :where(), :has()
- [ ] Псевдоэлементы ::before, ::after, ::marker
- [ ] Атрибутные селекторы [attr^=], [attr$=], [attr*=]
- [ ] Комбинаторы и специфичность на практике
