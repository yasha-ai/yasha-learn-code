...
<head>
  ...
  <meta name="twitter:title" content="Интерактивный пример Twitter Card">
  <meta name="twitter:description" content="Попробуйте изменить заголовок и описание!">
  <meta name="twitter:image" content="https://picsum.photos/600/300">
  <style>
...
<body>
  <h1>Редактируйте Twitter Card!</h1>
  <label for="title">Заголовок:</label>
  <input type="text" id="title" value="Интерактивный пример Twitter Card">
  <label for="description">Описание:</label>
  <input type="text" id="description" value="Попробуйте изменить заголовок и описание!">
  ...
  <script>
    ...
    titleInput.addEventListener('input', () => {
      document.querySelector('meta[name="twitter:title"]').setAttribute('content', titleInput.value);
    });

    descriptionInput.addEventListener('input', () => {
      document.querySelector('meta[name="twitter:description"]').setAttribute('content', descriptionInput.value);
    });
  <\/script>
</body>
</html>
