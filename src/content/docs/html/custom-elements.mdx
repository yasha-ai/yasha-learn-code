...
<body>
  <h3>Независимые Custom Elements</h3>
  <!-- Два одинаковых тега, но с независимым состоянием -->
  <my-greeting></my-greeting>
  <my-greeting></my-greeting>
  ...
  <script>
    ...
    class MyGreeting extends HTMLElement {
      constructor() {
        ...
        // Добавляем стили и разметку внутрь компонента
        this.shadowRoot.innerHTML = \`
          <style>
            button {
              background: #61dafb; border: none; padding: 10px 15px;
              border-radius: 5px; cursor: pointer; font-weight: bold;
            }
            button:hover { background: #4fa8c7; }
          </style>
          <button>Привет! Кликов: 0</button>
        \`;
        ...
        btn.addEventListener('click', () => {
          this.count++;
          btn.textContent = \`Привет! Кликов: \${this.count}\`;
        });
      }
    }

    // 2. Регистрируем новый тег
    customElements.define('my-greeting', MyGreeting);
  <\/script>
</body>
</html>
