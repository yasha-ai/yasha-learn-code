...
<head>
  ...
  <style>
    ...
    img { display: block; margin-bottom: 20px; width: 500px; }
  </style>
</head>
<body>
  ...
  <img src="https://via.placeholder.com/500x300?text=Image+4" alt="Image 4" loading="lazy">
  <img src="https://via.placeholder.com/500x300?text=Image+5" alt="Image 5" loading="lazy">
</body>
</html>
`
  }}
