...
<head>
  ...
  <style>
    ...
    #draggable { width: 100px; height: 100px; background-color: lightblue; cursor: move; text-align: center; line-height: 100px; margin-bottom: 20px; }
    #dropzone { width: 200px; height: 200px; border: 2px dashed gray; text-align: center; line-height: 200px; }
  </style>
</head>
<body>

  <div id="draggable" draggable="true">Drag</div>
  ...
  <script>
    ...
    draggable.addEventListener('dragstart', (event) => { event.dataTransfer.setData("text", event.target.id); });
