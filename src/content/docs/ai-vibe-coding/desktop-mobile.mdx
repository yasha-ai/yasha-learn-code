...
![Desktop и Mobile приложения с ИИ](/lessons/ai-vibe-desktop-mobile.png)
...
- [Electron](https://www.electronjs.org/) — фреймворк для desktop приложений на JavaScript
- [Tauri](https://tauri.app/) — лёгкий desktop фреймворк на Rust
- [React Native](https://reactnative.dev/) — фреймворк для мобильных приложений
- [Flutter](https://flutter.dev/) — UI toolkit от Google для мобильных и desktop
- [Rork](https://rork.app/) — AI-билдер нативных мобильных приложений
