...
![OpenClaw: твой личный AI-агент](/lessons/ai-vibe-openclaw.png)
...
- [OpenClaw](https://openclaw.ai/) — официальный сайт
- [Документация OpenClaw](https://docs.openclaw.ai/) — официальная документация
- [ClawHub](https://clawhub.com/) — маркетплейс skills и интеграций
- [OpenClaw на GitHub](https://github.com/openclaw/openclaw) — исходный код (MIT)
