---
title: "2. SOLID: Single Responsibility"
sidebar:
  order: 2
---
...
### Playground: SRP в действии

<Playground client:visible template="vanilla" files={{ '/index.js': `// SRP: каждый класс — одна ответственность
...
// Demo
const service = new UserService(new UserValidator(), new UserRepository());
try {
  service.register("A", "bad");
} catch (e) { console.log("Error:", e.message); }

const user = service.register("Alice", "alice@mail.com");
