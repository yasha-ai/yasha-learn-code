---
title: "10. MongoDB: Aggregation Pipeline"
sidebar:
  order: 10
---
...
<Playground client:visible
  template="vanilla"
  files={{
    "/index.js": `// JavaScript-эквивалент MongoDB Aggregation Pipeline

const orders = [
  { customer: "Алиса", product: "Ноутбук", amount: 89000, city: "Москва" },
  { customer: "Борис", product: "Мышь", amount: 1500, city: "Питер" },
  { customer: "Алиса", product: "Клавиатура", amount: 3000, city: "Москва" },
  { customer: "Вика", product: "Монитор", amount: 25000, city: "Питер" },
  { customer: "Борис", product: "Наушники", amount: 5000, city: "Питер" },
];

// $match — фильтрация
const matched = orders.filter(o => o.city === "Питер");
console.log("$match city=Питер:", matched.length);

// $group — группировка
const grouped = Object.groupBy
  ? Object.groupBy(orders, o => o.customer)
  : orders.reduce((acc, o) => {
      (acc[o.customer] = acc[o.customer] || []).push(o);
      return acc;
    }, {});
...
console.log("$group + $sum:", totals);

// $sort
const sorted = [...totals].sort((a, b) => b.total - a.total);
console.log("$sort by total DESC:", sorted);
`
  }}
/>
