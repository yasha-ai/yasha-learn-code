...
<Playground client:visible
  template="vanilla"
  files={{
    "/index.js": `// JavaScript-эквивалент SQL-операции
// PostgreSQL: CREATE TABLE, INSERT, SELECT

// Имитация таблицы в JavaScript
const users = [
  { id: 1, name: "Алиса", email: "alice@mail.ru", age: 25 },
  { id: 2, name: "Борис", email: "boris@mail.ru", age: 30 },
  { id: 3, name: "Вика", email: "vika@mail.ru", age: 22 },
  { id: 4, name: "Григорий", email: "grig@mail.ru", age: 35 },
];

// SELECT * FROM users WHERE age > 25
const filtered = users.filter(u => u.age > 25);
console.log("WHERE age > 25:", filtered);

// SELECT name, email FROM users ORDER BY age DESC
const sorted = [...users]
  .sort((a, b) => b.age - a.age)
  .map(({ name, email }) => ({ name, email }));
console.log("ORDER BY age DESC:", sorted);

// SELECT COUNT(*) FROM users WHERE age >= 25
const count = users.filter(u => u.age >= 25).length;
console.log("COUNT WHERE age >= 25:", count);
