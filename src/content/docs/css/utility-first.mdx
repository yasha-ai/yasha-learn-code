---
title: "59. Utility-first (Tailwind подход)"
sidebar:
  order: 62
---
...
<head>
  ...
  <title>Utility-first Demo</title>
  <style>
...
<body>
  <button class="bg-blue-500 text-white p-4 rounded font-bold text-xl cursor-pointer" onclick="alert('Clicked!')">
    Кнопка
  </button>
</body>
</html>
