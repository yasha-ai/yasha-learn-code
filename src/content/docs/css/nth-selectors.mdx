---
title: "10. Псевдоклассы :nth-child и :nth-of-type"
sidebar:
  order: 11
---
...
<head>
  ...
  <style>
    ...
    .container > * { margin: 5px; padding: 5px; border: 1px solid #555; }
    .container p:nth-child(2) { background-color: lightcoral; }
    .container p:nth-of-type(2) { font-weight: bold; }
  </style>
</head>
<body>
  <div class="container">
  ...
  <script>
    // Ничего интерактивного, просто для примера
  <\/script>
</body>
</html>
`
