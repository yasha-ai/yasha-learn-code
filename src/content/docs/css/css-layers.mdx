...
<body>
  ...
  <p>Кнопка зелёная — слой <code>theme</code> объявлен после <code>base</code>, поэтому он выигрывает. Правило без слоя (<code>margin</code>) имеет ещё более высокий приоритет, но задаёт только отступ.</p>
</body>
</html>
`
  }}
