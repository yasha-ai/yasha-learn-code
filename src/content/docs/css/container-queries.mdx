---
title: "44. Container Queries (@container)"
sidebar:
  order: 45
---
...
<body>
  <div class="controls">
    <label>
      ...
      <input type="range" min="200" max="700" value="400" oninput="document.getElementById('wrapper').style.width=this.value+'px'; document.getElementById('lbl').textContent=this.value+'px'">
    </label>
  </div>
