---
title: "11. Псевдоклассы :is(), :where(), :has()"
sidebar:
  order: 12
---
...
<head>
  ...
  <style>
    ...
    div { margin-bottom: 10px; padding: 10px; border: 1px solid #444; }
    .container:has(.special) { border: 2px solid orange; }
    button { padding: 5px 10px; cursor: pointer; }
    :where(h1, h2) { font-weight: normal; }
  </style>
</head>
<body>
  <div class="container">
    ...
    <button onclick="addElement()">Add Special</button>
  </div>
