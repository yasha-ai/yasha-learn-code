---
title: "47. :has() — родительский селектор"
sidebar:
  order: 48
---
...
<head>
  ...
  <style>
    ...
    .container { border: 1px solid #666; padding: 10px; margin: 10px; }
    .container:has(button) { border: 2px solid lightblue; background-color: #333; }
