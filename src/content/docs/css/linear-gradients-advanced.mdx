---
title: "30. Линейные градиенты продвинутые"
sidebar:
  order: 31
---
...
<head>
  ...
  <style>
    ...
    .gradient-box { width: 200px; height: 50px; margin: 10px; border: 1px solid #ccc; }
  </style>
</head>
<body>
  <h1>Linear Gradients</h1>

  <div class="gradient-box" style="background: linear-gradient(to right, red, blue);"></div>
  <div class="gradient-box" style="background: linear-gradient(45deg, red, green, blue);"></div>
  <div class="gradient-box" style="background: linear-gradient(to right, red 20%, yellow 60%, blue 80%);"></div>
  <div class="gradient-box" style="background: repeating-linear-gradient(45deg, red, yellow 7px, green 14px);"></div>

  <script>
    // No JavaScript needed for this example, but keeping the tag for potential future interactivity.
  <\/script>
</body>
</html>
`
