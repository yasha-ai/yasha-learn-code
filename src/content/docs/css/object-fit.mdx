---
title: "51. object-fit и object-position"
sidebar:
  order: 52
---
...
<head>
  ...
  <style>
    ...
    .container { width: 200px; height: 150px; border: 1px solid white; margin: 10px; }
    img { width: 100%; height: 100%; object-fit: cover; object-position: center; }
    select { background: #333; color: white; border: 1px solid white; padding: 5px; }
  </style>
</head>
<body>
  <div class="container">
    <img id="myImage" src="https://via.placeholder.com/300x200" alt="Пример">
  </div>
  ...
  <script>
    const select = document.getElementById('objectFit');
