---
title: "52. Современные единицы: dvh, svh, lvh, cqi"
sidebar:
  order: 53
---
...
<body>
    ...
    <div class="box" style="height: 30svh;">30svh</div>
    <div class="box" style="height: 30dvh;">30dvh</div>
    <div class="box" style="height: 30lvh;">30lvh</div>

    <script>
        // Simple script to demonstrate dynamic viewport changes (optional)
