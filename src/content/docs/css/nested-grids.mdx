...
<head>
  ...
  <style>
    ...
    .container { display: grid; grid-template-columns: 1fr 2fr; gap: 10px; padding: 10px; }
    .item { background-color: lightblue; padding: 10px; border: 1px solid black; }
    .nested-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 5px; background-color: lightgreen; }
    .nested-item { background-color: lightcoral; padding: 5px; border: 1px solid black; }
  </style>
</head>
<body>
  <div class="container">
