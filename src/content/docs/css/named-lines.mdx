...
![Иллюстрация к уроку](/lessons/css-named-lines.png)
...
<style>
  ...
  .grid {
    display: grid;
    grid-template-columns: [sidebar-start] 150px [sidebar-end content-start] 1fr [content-end];
    grid-template-rows: [header-start] 60px [header-end main-start] 1fr [main-end footer-start] 40px [footer-end];
    gap: 10px;
    height: 300px;
  }
  .grid > div { padding: 10px; border-radius: 8px; display: flex; align-items: center; justify-content: center; }
  .header { grid-column: sidebar-start / content-end; grid-row: header-start / header-end; background: #61dafb; color: #282c34; }
  .sidebar { grid-column: sidebar-start / sidebar-end; grid-row: main-start / main-end; background: #98c379; color: #282c34; }
  .content { grid-column: content-start / content-end; grid-row: main-start / main-end; background: #c678dd; }
  .footer { grid-column: sidebar-start / content-end; grid-row: footer-start / footer-end; background: #e5c07b; color: #282c34; }
</style>
</head>
<body>
  <h3>Именованные линии Grid</h3>
  <div class="grid">
    <div class="header">Header (sidebar-start → content-end)</div>
    <div class="sidebar">Sidebar</div>
    <div class="content">Content</div>
    <div class="footer">Footer (sidebar-start → content-end)</div>
  </div>
</body>
</html>
`
