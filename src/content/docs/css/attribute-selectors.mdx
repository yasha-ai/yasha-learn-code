...
<head>
    ...
    <style>
        ...
        input[type="text"] { border: 2px solid orange; padding: 5px; margin-bottom: 10px; background-color: #333; color: white; }
        input[required] { border-color: red; }
        a[target="_blank"] { color: lightblue; text-decoration: none; }
    </style>
</head>
<body>
    ...
    <p>Try changing the 'required' attribute in the second input.</p>
</body>
</html>
`
  }}
