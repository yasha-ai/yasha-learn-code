---
title: "35. perspective и 3D-трансформации"
sidebar:
  order: 36
---
...
<head>
  ...
  <style>
    ...
    .container { width: 200px; height: 200px; perspective: 400px; margin: 20px; }
    .box { width: 100px; height: 100px; background-color: lightblue; transform-origin: center; transition: transform 0.5s; position: relative; }
  </style>
</head>
<body>
  <div class="container">
  ...
  <script>
    ...
    box.addEventListener('click', () => {
      ...
      box.style.transform = \`rotateX(\${randomX}deg) rotateY(\${randomY}deg) translateZ(20px)\`;
    });
  <\/script>
</body>
</html>
