...
header { grid-area: header; background-color: #333; padding: 10px; text-align: center; }
nav { grid-area: nav; background-color: #444; padding: 10px; }
main { grid-area: main; background-color: #555; padding: 10px; }
footer { grid-area: footer; background-color: #333; padding: 10px; text-align: center; }
