---
title: "15. flex-grow, flex-shrink, flex-basis детально"
sidebar:
  order: 16
---
...
<head>
    ...
    <style>
        ...
        .container { display: flex; width: 500px; border: 1px solid white; margin: 20px; }
        .item { flex-grow: 1; flex-shrink: 1; flex-basis: 0; padding: 20px; text-align: center; background-color: #444; }
    </style>
</head>
<body>
    <div class="container">
    ...
    <p>Each item has <code>flex-grow: 1</code>, <code>flex-shrink: 1</code>, and <code>flex-basis: 0</code>.</p>
</body>
</html>
`
  }}
