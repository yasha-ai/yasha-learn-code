...
<html>
<head>
  <title>TypeScript satisfies</title>
  <style>
...
<body>
  ...
  <script type="module">
    ...
    output.textContent = \`Primary color: \${colors.primary}\`;

    // Try changing 'red' to 'yellow' above and see the error!
  <\/script>
</body>
</html>
`
