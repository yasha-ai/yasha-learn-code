...
<html>
<head>
  <title>Generic Class Demo</title>
  <style>
...
<body>
  <h1>Generic Class Demo</h1>
  <button id="numberBtn">Number Box</button>
  <button id="stringBtn">String Box</button>
  <div id="output"></div>
  ...
  <script type="module">
    ...
    numberBtn.addEventListener('click', () => {
      ...
      outputDiv.textContent = 'Number Box Value: ' + box.getValue();
    });

    stringBtn.addEventListener('click', () => {
      const box = new Box<string>('Hello Generic!');
      outputDiv.textContent = 'String Box Value: ' + box.getValue();
    });
  <\/script>
</body>
</html>
