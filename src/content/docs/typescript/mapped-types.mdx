...
<body>
  ...
  <script type="module">
    ...
    updateButton.textContent = 'Update Person';
    ...
    updateButton.addEventListener('click', () => {
      // person.name = nameInput.value; // Error: Cannot assign to 'name' because it is a read-only property.
      outputDiv.textContent = \`Name: \${person.name}, Age: \${person.age}\`;
    });
