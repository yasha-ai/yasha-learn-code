---
title: "21. Расширение интерфейсов"
sidebar:
  order: 21
---
...
<html>
<head>
  <title>TypeScript: Interface Extending</title>
  <style>
...
<body>
  ...
  <script type="module">
    ...
    const myDog: Dog = {
      ...
      bark() {
        document.getElementById('output').textContent = 'Woof! My name is ' + this.name + ' and I am a ' + this.breed + '.';
      }
    };

    const button = document.createElement('button');
    button.textContent = 'Make Dog Bark';
    button.onclick = () => myDog.bark();
