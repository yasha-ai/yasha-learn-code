---
title: "16. Дискриминированные объединения"
sidebar:
  order: 16
---
...
<body>
  <h1>Shape Area</h1>
  <button id="circleBtn">Calculate Circle Area</button>
  <button id="squareBtn">Calculate Square Area</button>
  <p id="result"></p>
  ...
  <script type="module">
    ...
    circleBtn.addEventListener('click', () => {
      ...
      resultP.textContent = \`Circle area: \${getArea(circle)}\`;
    });

    squareBtn.addEventListener('click', () => {
      const square: Square = { kind: 'square', sideLength: 5 };
      resultP.textContent = \`Square area: \${getArea(square)}\`;
    });
  <\/script>
</body>
</html>
