---
title: "11. Условные типы (Conditional Types)"
sidebar:
  order: 11
---
...
<html>
<head>
  <title>TypeScript Conditional Types</title>
  <style>
    body {
...
<body>
  <h1>TypeScript Conditional Types</h1>
  <p>Enter a value:</p>
  ...
  <script>
    ...
    inputElement.addEventListener('input', () => {
      ...
      // TypeScript code (simulated)
      /** @type {<T>(value: T) => T extends string ? 'string' : 'not string'} */
      ...
      const typeResult = checkType(inputValue);
      resultElement.textContent = \`Type: \${typeResult}\`;
    });
  <\/script>
</body>
</html>
