...
<body>
  <button id="myButton">Check Type</button>
  <div id="output"></div>
  ...
  <script>
    ...
    button?.addEventListener('click', () => {
      if (typeof myVariable === 'number') {
        output.textContent = 'myVariable is a number: ' + myVariable;
      } else {
        output.textContent = 'myVariable is NOT a number.';
      }
    });
  <\/script>
</body>
