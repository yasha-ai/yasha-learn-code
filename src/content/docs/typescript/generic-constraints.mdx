...
<html>
<head>
  <title>TypeScript Generic Constraints</title>
  <style>
...
<body>
  ...
  <button id="describeButton">Describe Person</button>
  <div id="output"></div>
  ...
  <script type="module">
    ...
    document.getElementById('describeButton')?.addEventListener('click', () => {
      ...
      try {
        ...
        const description = describe(person);
        (document.getElementById('output') as HTMLDivElement).textContent = description;
      } catch (error) {
        (document.getElementById('output') as HTMLDivElement).textContent = 'Error: Invalid input.';
      }
    });
  <\/script>
</body>
