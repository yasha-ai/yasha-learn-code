...
// Mini Jest API implementation for demo
const results = [];
...
describe('reverseString', () => {
  it('reverses a string', () => expect(reverseString('hello')).toBe('olleh'));
  it('empty string', () => expect(reverseString('')).toBe(''));
});

describe('capitalize', () => {
  it('first letter uppercase', () => expect(capitalize('hello')).toBe('Hello'));
  it('already uppercase', () => expect(capitalize('Hello')).toBe('Hello'));
});
