---
title: "16. Формы и взаимодействие"
sidebar:
  order: 15
---
...
// Тестирование форм с RTL

console.log('=== Тестирование форм ===\n');

console.log(\`test('заполнение и отправка формы', async () => {
...
console.log('\n✅ Используйте getByLabelText для полей формы');
console.log('✅ Проверяйте ошибки валидации');
console.log('✅ Тестируйте submit callback');
`
}} />
