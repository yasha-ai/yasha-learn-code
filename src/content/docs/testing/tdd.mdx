...
// Step 1: RED — write test before code
console.log('=== TDD: FizzBuzz ===\n');
console.log('1. RED — write tests:\n');
...
console.log('2. GREEN — implement the function:\n');
test('returns number as string', () => expect(fizzBuzz(1)).toBe('1'));
test('divisible by 3 → Fizz', () => expect(fizzBuzz(3)).toBe('Fizz'));
test('divisible by 5 → Buzz', () => expect(fizzBuzz(5)).toBe('Buzz'));
test('divisible by 15 → FizzBuzz', () => expect(fizzBuzz(15)).toBe('FizzBuzz'));

console.log('\n3. REFACTOR — improve without changing behavior');
console.log('   Cycle repeats for each new feature!');
`
}} />
