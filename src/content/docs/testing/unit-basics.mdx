...
test('formats cents to rubles', () => expect(formatPrice(1999)).toBe('19.99 ₽'));
test('zero', () => expect(formatPrice(0)).toBe('0.00 ₽'));

console.log('\n=== validateEmail ===');
test('valid email', () => expect(validateEmail('a@b.com')).toBe(true));
test('without @', () => expect(validateEmail('invalid')).toBe(false));

console.log('\n=== clamp ===');
test('within range', () => expect(clamp(5, 0, 10)).toBe(5));
test('below minimum', () => expect(clamp(-5, 0, 10)).toBe(0));
test('above maximum', () => expect(clamp(15, 0, 10)).toBe(10));
`
}} />
