...
// Playwright Actions — interacting with elements

console.log('=== Locators ===\n');

const locators = [
  { method: "page.getByRole('button', { name: 'Submit' })", priority: '1' },
  { method: "page.getByLabel('Email')", priority: '2' },
  { method: "page.getByPlaceholder('Enter...')", priority: '3' },
  { method: "page.getByText('Hello')", priority: '4' },
...
console.log(\`test('search form', async ({ page }) => {
  ...
  // Hover
  await page.getByText('Result 1').hover();

  // Select
  await page.getByLabel('Sort').selectOption('date');

  // Checkbox
  await page.getByLabel('New only').check();
