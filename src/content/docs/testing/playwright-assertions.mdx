...
<Playground client:visible template="vanilla" files={{
  '/index.js': `// Example test code (run with Playwright)
// Playwright Assertions — checks in E2E tests

console.log('=== Web-first Assertions ===\n');
console.log('Playwright automatically waits for the condition!\n');

const assertions = [
  { code: "await expect(locator).toBeVisible()", desc: 'Element is visible' },
  { code: "await expect(locator).toBeHidden()", desc: 'Element is hidden' },
  { code: "await expect(locator).toHaveText('...')", desc: 'Element text' },
  { code: "await expect(locator).toHaveValue('...')", desc: 'Input value' },
  { code: "await expect(locator).toBeChecked()", desc: 'Checkbox checked' },
  { code: "await expect(locator).toBeEnabled()", desc: 'Not disabled' },
  { code: "await expect(locator).toHaveClass(/active/)", desc: 'CSS class' },
  { code: "await expect(locator).toHaveCount(3)", desc: 'Element count' },
  { code: "await expect(page).toHaveURL('/dashboard')", desc: 'Page URL' },
  { code: "await expect(page).toHaveTitle(/App/)", desc: 'Page title' },
];
...
console.log('All assertions auto-retry until timeout (default 5s)');
`
}} />
