...
<Playground client:visible
  template="vanilla"
  files={{
    "/index.js": `// JavaScript-эквивалент ООП Python

// Python: class Animal:  def __init__(self, name):
class Animal {
...
// Python: class Dog(Animal): (наследование)
...
class Circle {
  ...
  set radius(v) {
    if (v < 0) throw new Error("Радиус < 0");
    this._radius = v;
  }
}

const c = new Circle(5);
console.log("\\nПлощадь:", c.area.toFixed(2));
c.radius = 10;
console.log("Новая площадь:", c.area.toFixed(2));
`
  }}
/>
