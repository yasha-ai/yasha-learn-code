...
<Playground client:visible
  template="vanilla"
  files={{
    "/index.js": `// JavaScript-эквивалент модулей Python
// Python: import math     -> JS: import * as math from "math"
// Python: from math import pi -> JS: import { pi } from "math"

// Имитация модульной системы
const mathModule = {
  pi: 3.14159,
  sqrt: (x) => Math.sqrt(x),
...
console.log("math.sqrt(16):", mathModule.sqrt(16));

// from math import pi, sqrt
const { pi, sqrt } = mathModule;
console.log("pi:", pi);
...
console.log("\\nСравнение:");
console.log("Python: pip + requirements.txt");
console.log("JS:     npm + package.json");
console.log("Python: __init__.py = JS: index.js");
`
  }}
/>
