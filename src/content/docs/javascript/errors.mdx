  ...
  <script>
    ...
    window.runTryCatch = function() {
      ...
      try {
        ...
        lines.push('finally => очистка ресурсов');
      }
      out.textContent = lines.join('\\n');
    }

    window.runAsync = async function(succeed) {
