---
title: "39. Публичные и приватные поля (#)"
sidebar:
  order: 39
---
...
<body>
  ...
  <script>
    ...
    window.dep = function() { acc.deposit(100); lines.push('deposit(100) -> ' + acc.getBalance()); render(); }
    window.wdr = function() { acc.withdraw(50); lines.push('withdraw(50)  -> ' + acc.getBalance()); render(); }
    window.showBal = function() { lines.push('getBalance()  = ' + acc.getBalance() + '  (публичный метод)'); render(); }
