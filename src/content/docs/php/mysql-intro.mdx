...
<body>
  <h1>MySQL Intro (Simulated)</h1>
  <p id="output">Click the button to simulate fetching data from MySQL.</p>
  <button onclick="getData()">Get Data</button>

  <script>
    function getData() {
      // Simulate fetching data from MySQL
      const data = "Data from MySQL: Hello, World!";
