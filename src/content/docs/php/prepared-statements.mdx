...
<head>
    ...
    <title>Prepared Statements Demo</title>
    <style>
        body {
...
<body>
    <h1>Prepared Statements Demo</h1>
    ...
    <script>
        function greet() {
            ...
            // Simulate prepared statement (client-side, for demo)
            const safeName = name.replace(/[<>"']/g, ""); // Basic escaping
            greeting.textContent = \`Hello, \${safeName}!\`;
        }
    <\/script>
</body>
</html>
