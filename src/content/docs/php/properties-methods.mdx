...
<html>
<head>
  <title>PHP Properties & Methods</title>
  <style>
    ...
    button { background-color: #61dafb; border: none; color: #282c34; padding: 10px 20px; font-size: 16px; cursor: pointer; border-radius: 5px; }
    #output { margin-top: 20px; }
  </style>
</head>
<body>
  <div class="container">
    <h1>PHP Class Example</h1>
    <button onclick="runExample()">Run Example</button>
    <div id="output"></div>

    <script>
      function runExample() {
        // Simulate PHP class behavior in JavaScript
        class MyClass {
          constructor(name) {
