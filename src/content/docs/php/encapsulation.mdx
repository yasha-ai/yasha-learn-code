...
<head>
    ...
    <style>
        ...
        .container { border: 1px solid #444; padding: 20px; border-radius: 5px; text-align: center; }
        button { background-color: #61dafb; color: #282c34; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; }
    </style>
</head>
<body>
    <div class="container">
    ...
    <script>
        class Counter {
            ...
            getCount() { //Public method to access the private field
                return this.#count;
            }
