...
<head>
    ...
    <title>PHP File Interaction</title>
    <style>
...
<body>
    <h1>PHP File Interaction</h1>
    <button id="createFile">Create & Read File</button>
    <div id="output"></div>

    <script>
        document.getElementById('createFile').addEventListener('click', function() {
            fetch('create_and_read.php')
