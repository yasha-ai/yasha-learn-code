...
<head>
  ...
  <style>
    ...
    input { background: #333; color: white; border: none; padding: 5px; margin: 5px; }
...
<body>
  ...
  <script>
    function checkUser() {
      ...
      // In a real application, NEVER directly embed user input in SQL queries.
      // This is just for demonstration purposes.
      const sqlQuery = "SELECT * FROM users WHERE username = '" + username + "';";
      document.getElementById('result').textContent = "Query: " + sqlQuery;
    }
  <\/script>
</body>
</html>
