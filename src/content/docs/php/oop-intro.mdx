...
<head>
    ...
    <style>
        ...
        button { padding: 10px 20px; background-color: #61dafb; border: none; cursor: pointer; color: #282c34; font-weight: bold; }
        #output { margin-top: 20px; }
    </style>
</head>
<body>
    <h1>Classes and Objects Demo</h1>
    <button id="createButton">Create Object</button>
    <div id="output"></div>
    ...
    <script>
        ...
        document.getElementById("createButton").addEventListener("click", function() {
            const myGreeting = new Greeting("User");
            document.getElementById("output").textContent = myGreeting.greet();
        });
    <\/script>
</body>
</html>
