...
<head>
    ...
    <style>
        ...
        input, button { padding: 8px; margin: 5px; border: none; border-radius: 4px; background-color: #3e4451; color: white; }
        button { cursor: pointer; }
        #message { margin-top: 10px; }
    </style>
</head>
<body>
    <h1>PHP Email Sender (Simulated)</h1>
    ...
    <script>
        function sendEmail() {
            ...
            if (email) {
                messageElement.textContent = \`Email sent to: \${email} (Simulated)\`;
            } else {
