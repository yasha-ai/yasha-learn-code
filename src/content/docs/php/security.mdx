...
<head>
  ...
  <style>
    ...
    input { background-color: #333; color: white; border: none; padding: 5px; margin-bottom: 10px; }
    div { margin-top: 10px; }
  </style>
</head>
<body>
  <h1>PHP Security Demo</h1>
  ...
  <script>
    function greet() {
      ...
      // In real PHP, you'd sanitize this input!
